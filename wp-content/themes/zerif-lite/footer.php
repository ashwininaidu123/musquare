...
<div class="container">
	...
	<?php
		$footer_sections = 0;
		$zerif_address = get_theme_mod('zerif_address',__('Regent Prime, Unit 107, 48-50, Whitefield Main Rd, Whitefield, Bengaluru, Karnataka 560066','zerif-lite'));
		$zerif_address_icon = get_theme_mod('zerif_address_icon',get_template_directory_uri().'/images/map25-redish.png');
		
		$zerif_email = get_theme_mod('zerif_email','<a href="mailto:contact@musquare.com">contact@musquare.com</a>');
		$zerif_email_icon = get_theme_mod('zerif_email_icon',get_template_directory_uri().'/images/envelope4-green.png');
		
		$zerif_phone = get_theme_mod('zerif_phone','<a href="tel:8 553 583 089">8 553 583 089</a>');
